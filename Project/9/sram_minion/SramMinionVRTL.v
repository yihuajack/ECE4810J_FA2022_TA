...
`ifndef SRAM_MINION_VRTL_V
`define SRAM_MINION_VRTL_V
...
module sram_minion_SramMinionVRTL
(
  input  logic         clk,
  input  logic         reset,
  ...
  // TODO: M0 stage combinational logic
  assign sram_addr_M0 =
  assign sram_wen_M0  =
  assign sram_en_M0   =
  ...
  assign memresp_msg_M1.type_  =
  assign memresp_msg_M1.opaque =
  assign memresp_msg_M1.test   =
  assign memresp_msg_M1.len    =
  assign memresp_msg_M1.data   = // Connect data to zero on write requests
  ...
  // TODO: Instantiate memresp_queue
  ...
  // TODO: Instantiate memresp_trace
